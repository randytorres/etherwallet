...
<section class="col-sm-8">
  <div class="block">
    ...
    <!-- To Address -->
    <div class="row form-group input-group sendTx-address col-sm-11">
      <address-field placeholder="0x7cB57B5A97eAbe94205C07890BE4c1aD31E486A8" var-name="tx.to"></address-field>
      <div class="input-group-btn lookup-dropdown">
        <label>Lookup</label>
        <a style="min-width: 170px" class="btn btn-default dropdown-toggle" class="dropdown-toggle" ng-click="" ng-class="dropdownEnabled ? '' : 'disabled'">
